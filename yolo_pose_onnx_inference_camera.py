...
#python yolo_pose_onnx_inference_camera.py
parser = argparse.ArgumentParser()
parser.add_argument("--model-path", type=str, default="./weights/20240114.onnx")
parser.add_argument("--img-path", type=str, default="./sample_list.txt")
