...
def detect(opt):
    ...
    (save_dir / 'labels ' if (save_txt or save_txt_tidl) else save_dir).mkdir(parents=True, exist_ok=True)  # make dir 20240109
                ...
                for det_index, (*xyxy, conf, cls) in enumerate(det[:,:6]):
                    ...
                    if save_txt:  # Write to file
                        ...
                        for kip in range(8):
                            ...
                            # print('未归一化',x_pt0, y_pt0)
                            x_pt = x_pt0 / im0.shape[1]
                            y_pt = y_pt0 / im0.shape[0]
                            # print('归一化',x_pt, y_pt)
                            line2 = ' ' + str(x_pt)[0:10] + ' ' + str(y_pt)[0:10]
